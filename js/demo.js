...
function loadDemoData(){
  ...
  const members = [
    ...
    {id:'m11',name:'Logan Price',initials:'LP',role:'Member',classYear:'Sophomore',year:2027,liveIn:false,memberStatus:'New Member',major:'Mechanical Engineering',hometown:'Cedar Rapids, IA'},
    {id:'m12',name:'Blake Foster',initials:'BF',role:'Member',classYear:'Freshman',year:2028,liveIn:false,memberStatus:'New Member',major:'Finance',hometown:'Naperville, IL'},
    {id:'m13',name:'Owen Reed',initials:'OR',role:'Member',classYear:'Freshman',year:2028,liveIn:false,memberStatus:'New Member',major:'Undecided',hometown:'Omaha, NE'},
...
// file, so this redefinition wins). This is a frontend-only demo with no real backend, so instead
// of actually generating and downloading a file, it just confirms what the button does in the
// live product — no Blob/file-save dialog popping up unprompted during a walkthrough.
// ══════════════════════════════════════════════
async function tmGenerateAndDownload() {
  ...
  toast('In the full ATO Executive System, this generates and downloads a complete structured JSON export of your chapter\'s full year of data for True Merit reporting. File downloads are disabled in this demo.', 'info', 7000);
}
