...
const EXEC_POSITIONS=[
  ...
  {role:'Risk Manager',       icon:'shield', color:'var(--rd-tx)', bg:'var(--rd-bg)',
   responsibilities:['Enforce all risk management policies at events','Schedule and manage sober brother rotations','Conduct event safety walkthroughs','Handle incident documentation and reporting','Liaise with ISU and ATO national on risk matters'],
   recurringTasks:['Sober brother schedule filled 1 week in advance','Event approval sign-off for every social event','Weekly check of sober brother confirmations','Risk policy review at start of each semester','Post-event incident reports (if applicable)'],
   wishIKnew:'The sober bro schedule is your most important recurring task. Never let it go unfilled. One incident without documentation ruins the chapter. Get your FIPG training done in the first week and make sure exec knows the policy cold.'},
